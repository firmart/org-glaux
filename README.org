...
** Wishlist
 - Support showing page description on point with (tooltip)
 - Support image gallery
 - Support link archiving (archive link with wayback machine; access archived
   link if it's a dead link)
** Credits
